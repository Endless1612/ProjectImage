...
public class SobelEdgeDetector implements EdgeDetector {
    ...
    public File detectEdges(File inputFile) throws IOException {
        ...
        double[][] gradientX = applyConvolution(grayImage, SOBEL_X);
        double[][] gradientY = applyConvolution(grayImage, SOBEL_Y);
        ...
        File outputFile = new File("sobel_output.png");
    ...
    // Apply convolution with Sobel kernel
